  ...
  return (
    <div className='landingpage-container'>
        ...
        <section className='how-it-works' id='how-it-works' ref={howItWorksRef}>
                <div className='how-it-works-details'>
                    ...
                    <div className='icon-text'>
                        ...
                        <p className='how-it-works-text'>Make a Request- Tell us what bill you need help with (school, fees, rent, hospital bills, etc).</p>
                    </div>
                    <div className='icon-text'>
                        <div className='how-it-works-icon'>
                        <img src={Invoice} alt='invoice-icon'className='how-it-works-img'  />
                        </div>
                        <p  className='how-it-works-text'>Sponsors pay directly to the service provider. no middleman wahala</p>
                    </div>
                    <div className='icon-text'>
                        <div className='how-it-works-icon'>
                ...
                <div >
                    <img src={shots} className='how-it-works-shots'/>
                </div>
        </section>
        ...
        <section className='why-choose' id='why-choose'>
                <div >
                    <img src={shots2} className='why-choose-shots'/>
                </div>
                <div className='how-it-works-details'>
                    ...
                    <div className='icon-text'>
                        ...
                        <p className='how-it-works-text'>No More Awkwardness:<br></br>
                    ...
                    <div className='icon-text'>
                        ...
                        <p  className='how-it-works-text'>Secure Transactions:<br></br>
                        Money goes straight to the bills- not through the requester.</p>
                    </div>
                    <div className='icon-text'>
                        <div className='how-it-works-icon'>
                        <img src={man} alt='man-runnin-icon' className='how-it-works-img' />
                        </div>
                        <p  className='how-it-works-text'>Fast & Easy:<br></br>
                    ...
                    <div className='icon-text'>
                        ...
                        <p  className='how-it-works-text'>Made for Every Nigerian:<br></br>
        ...
        <section className='get-started' id='get-started'>
            <div>
                ...
                <p className='get-started-text'>Join Thousands of Users and start Your <br></br>Financial Transformation</p>
                <Link to='/sign-up'><button className='join-one-btn'>Join Urgent2kay</button></Link> 
            </div>
            <div>
        ...
        <section className='partner' id="partner">
            <div className='partner-details'>
                ...
                <ul>
                    <li>Payment Gateways: Integration for seamless and secure <br></br>transactions.</li>
                    <li>Financial institutions: Collaboration on offering innovative <br></br>financial services.</li>
                    <li>Service Providers: We enable direct and bundled payments for <br></br>our services</li>
                </ul>
                <Link to='/'><button className='join-one-btn'>Partner With Us</button></Link>
            </div>
            <div>
        ...
        <footer className='footer'>
            <div className='footer-top'>
                <div className='footer-brand'>
                   <img className='urgent2kay-logo2' src={logo2} alt='urgent2kay logo'/>
                    <div className='social-icons'>
                      <img src={discord} alt="discord-icon" className=''/>
                ...
                <div className='footer-links'>
                    <div className='link-column'>
                        ...
                        <Link to="/"><p>Generate Request</p></Link>
                        <Link to="/"><p>Transaction History</p></Link>
                    </div>
                    <div className='link-column'>
                        <h4>Company</h4>
                        <Link to="/"><p>Our Teams</p></Link>
                        <Link to="/"><p>Our Values</p></Link>
                        <Link to="/"><p>Blog</p></Link>
                    </div>
                    <div className='link-column'>
                        <h4>Product</h4>
                        <Link to="/"><p>Information</p></Link>
                        <Link to="/"><p>Documentation</p></Link>
           ...
           <div className='footer-bottom'>
            <p>© 2025<img className='icon-logo-one' src={logo} alt='urgent2kay logo'/>. All rights reserved</p>
