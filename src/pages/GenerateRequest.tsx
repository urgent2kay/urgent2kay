...
import { IoIosFlash, IoIosCart, IoIosSchool, IoIosHome, IoIosCall, IoIosNutrition, IoIosCloudDownload, IoIosSend } from 'react-icons/io'; 
  ...
  <div className="balance-content">
    ...
    <span className="balance-amount">₦0.00 </span>
          ...
          <div className="request-container">
            ...
            <div className="request-item">
              <span className="request-text">Review and approve bundled requests to send payments directly to service providers.</span>
              <div className="create-bundle-text">
  Sponsor a Bundle →
</div>
            ...
            <div className="suggested-content">
              <div className="suggested-card suggested-card-yellow">
                ...
                <div className="suggested-info">
                  ...
                  <div className="suggested-description">For every successful referral, you and your friend both earn ₦1,000 in credits!</div>
              ...
              <div className="suggested-card">
                ...
                <div className="suggested-info">
                  ...
                  <div className="suggested-description">Complete your first bundle and get ₦500 free credits.</div>
              ...
              <div className="suggested-card">
                ...
                <div className="suggested-info">
                  ...
                  <div className="suggested-description">Get 10% cashback on all utility bills. Offer ends in 3 days!</div>
                </div>
              </div>
            </div>
          </div>
