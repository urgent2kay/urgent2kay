  ...
  return (
    <TemplatePage>
      ...
      <main className="main-content" style={isMobile ? mobileMainStyles : {}}>
        <div
          className="electricity-layout"
          style={isMobile ? mobileLayoutStyles : {}}
        >
          <div
            className="electricity-row"
            style={isMobile ? mobileRowStyles : {}}
          >
            <div
              className="electricity-section"
              style={isMobile ? mobileSectionStyles : {}}
            >
                  ...
                  {isMobile ? (
                    ...
                    <>
                      ...
                      <option value="abakaliki">
                        Abakaliki Electricity Distribution Company
                      </option>
                    </>
                  )}
                </select>
          ...
          <div className="amount-container">
            {["1000", "2000", "3000", "4000", "5000", "6000", "7000"].map(
              (amount) => (
